                ...
                <tr>
                  <td style="background:#ffffff;padding:36px;border-left:1px solid #e9eef5;border-right:1px solid #e9eef5;">
                    ...
                    <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#475569;">
                      A new invite link has been generated for you to access the
                      <strong>${BRANDING.shortName}</strong> portal. Use the button below to
...
export async function POST(req: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json({
      message: "Invite regenerated and email sent successfully",
      inviteLink,
    });
  } catch (error) {
